...
const form = document.getElementById('form');
    ...
    const familyLipids = form.querySelector('[name="family-lipids"]');
          ...
          docAtero = form.querySelector('[name="documental-aterosclerosis"]');
...
//Объявление каждого элемента формы
    ...
    if (isold.value < 40) {
        ...
        } else if (docAtero.checked == true || resultScore > 7.5 && isold.value < 50 || resultScore > 10 && isold.value >= 50 && isold.value < 70 || resultScore > 15 && isold.value >= 70 || ateroReveal.checked == true && ateroSize.value >= 50 || diabetes.checked == true && sdDamage.checked == true || diabetes.checked == true && sdDurability.value >= 20 || kidneyDisease.checked == true && skf.value < 30 || familyLipids.checked == true && familyDeath.checked == true || strokes.checked == true) {
        ...
        //Отображение блока тактики ведения пациента и назначение гиполипидемической терапии
